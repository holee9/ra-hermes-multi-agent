...
| 모델 | 유형 | 특징 |
|------|------|------|
| HnVUE | **SaMD** | 영상 획득·처리·표시 독립 GUI SW |
| Retrofit (HnX-R1) | **SiMD** | 기존 아날로그 시스템 디지털화 키트 (하드웨어 내장 SW) |
...
- 소프트웨어 의료기기 허가: HnVUE(SaMD) — SDS 필수 항목, IEC 62304 V&V, ISO 14971 리스크 관리; Retrofit(SiMD) — 기기 허가 일부로 IEC 62304 적용
