...
### Medical Imaging SW
| 모델 | 유형 | Classification Basis | Class |
|------|------|---------------------|-------|
| HnVUE | **SaMD** | Rule 11: SaMD — 진단·치료 결정에 영향 | IIa~IIb |
| Retrofit (HnX-R1) | **SiMD** | 하드웨어 디지털화 키트 내장 SW — Rule 11 SaMD 비적용, 기기 분류 적용 | IIa (기기 분류 따름) |

MDCG 2019-11 Rev.1 (2025-06): AI 기반 영상 분석 SW → 항상 MDSW로 분류, 최소 IIa. HnVUE(SaMD) 해당; Retrofit(SiMD) 기기 분류 루트 적용.
...
| 항목 | 시한 | 상태 |
|------|------|------|
| **EUDAMED UDI 의무 등록** | **2026-05-28** | Detector IIa, HnX-P1/PB IIb, HnVUE SaMD IIa~IIb, Retrofit SiMD (기기 분류) — Basic UDI-DI + UDI-DI 등록 |
| MDR 전환 IIb non-impl / IIa | **2028-12-31** | HnX-P1/PB (IIb), Detector (IIa), HnVUE SaMD (IIa~IIb), Retrofit SiMD (기기 분류) 조건 확인 필요 |

**EUDAMED UDI 2026-05-28 우선 대응**: 미등록 시 EU 시장 출하 불가. CE MDR 전 제품(Detector IIa, HnX-P1/PB IIb, HnVUE SaMD IIa~IIb, Retrofit SiMD 기기 분류) Basic UDI-DI 및 UDI-DI 등록 의무.
...
HnVUE (SaMD): Rule 11 → IIa~IIb (AI 기능 유무에 따라) / Retrofit HnX-R1 (SiMD): 하드웨어 키트 내장 SW — Rule 11 비적용, 기기 분류 루트
