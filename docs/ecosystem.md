...
## 2. 코드 개발 대상 레포 우선순위 (2026-06-10 기준)

| 순위 | 레포 | Open 이슈 | 현재 상태 | 우선 이유 |
|------|------|----------|----------|---------|
| 1 | `ra-med-bot` | 60개 | feat/issue-22-predicate 진행 중 | Wave 3 PREDICATE-001 구현 미완, 미결 이슈 최다 |
| 2 | `hybrid-ra-saas` | 10개 | 로컬 미클론, 원격만 존재 | 사전작업 이슈 진행 중, 최근 push 활발 |
| 3 | `ra-hermes-multi-agent` | 1개 | Phase 1~5 완료 | 에코시스템 오케스트레이터, 오늘 커밋 활발 |
